...
function Hero4() {
  ...
  return (
    <div
      ref={ref}
      className={`flex flex-col items-center justify-center min-h-screen p-4 sm:p-6 md:p-8 lg:p-12 overflow-hidden ${theme === 'dark' ? 'bg-black' : 'bg-white'}`}
    >
      <h2 className={`text-3xl font-bold mb-6 ${theme === 'dark' ? 'text-white' : 'text-black'}`}>
        <span className={`text-sky-500`}>Success</span> Stories
      </h2>
